...
public class _738Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _738(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 738), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 738);
    }
