...
public class _1217Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _1217(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 1217), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 1217);
    }


    @RepeatedTest(value = 200, name = "Caso de teste nº {currentRepetition}")
    void test() {
        p.solve();
