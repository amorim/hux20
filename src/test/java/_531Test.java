...
public class _531Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _531(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 531), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 531);
    }
