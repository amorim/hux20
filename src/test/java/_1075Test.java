...
public class _1075Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _1075(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 1075), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 1075);
    }


    @RepeatedTest(value = 16, name = "Caso de teste nº {currentRepetition}")
    void test() {
        p.solve();
