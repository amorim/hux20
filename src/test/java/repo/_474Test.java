...
public class _474Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _474(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 474), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 474);
    }
