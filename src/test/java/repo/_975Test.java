...
public class _975Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _975(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 975), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 975);
    }
