...
public class _863Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _863(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 863), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 863);
    }
