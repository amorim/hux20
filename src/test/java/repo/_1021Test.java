...
public class _1021Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _1021(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 1021), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 1021);
    }
