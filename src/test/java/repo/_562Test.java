...
public class _562Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _562(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 562), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 562);
    }
