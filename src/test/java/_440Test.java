...
public class _440Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _440(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 440), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 440);
    }
