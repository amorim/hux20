...
public class _771Test {
    ...
    void sobe(RepetitionInfo repetitionInfo) {
        ...
        p = new _771(FakeStreamsUtil.testCaseInstance(repetitionInfo.getCurrentRepetition(), 771), new PrintStream(fakeOut));
        oracle = FakeStreamsUtil.loadTestCase(repetitionInfo.getCurrentRepetition(), 771);
    }
